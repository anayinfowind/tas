                            ...
                            foreach ($modules as $key => $value) {
                               ...
                               if (!empty($moduledetail)) {
                                    foreach ($moduledetail as $key => $valuefinal) {
                                        $activityids = $DB->get_record('course_modules', array('instance' => $instance,'module'=>$moduleid));$alreadyenabled = $DB->get_record_sql( "SELECT id FROM {tool_leeloolxp_sync} where activityid = '$activity_ids->id' and enabled = '1'") ;
                                        $enabled = false;
                                        $enabled = true;
    ...
    foreach ($alldata as $key => $value) {
        ...
        if($i=='0') { 
            ...
            if(!empty($groupsname)) {
                ...
                if($usertype=='student') {
                    $lastlogin = date('Y-m-d h:i:s',$moodeluservalue->lastlogin);$moodleuserstudentarray[] = array(
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="tqs-left">
                                                                            ...
                                                                            echo $icon; ?>
                                                                            <span><?php $oldsectionsname  =  $sectionsdetails->name; echo $valuefinal->name; ?></span>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="tqs-right">
