            ...
            foreach ($enrolleduser as $key => $moodeluservalue) {
                ...
                if ($usertype == 'student') {
                    ...
                    if ($usertype == 'teacher') {
                        ...
                        $moodleuserteacherarrayy[] = array('username' => $moodeluservalueteacher->username,
                            ...
                            'user_pic_moodle_url' => $moodleurlpic,
                            'email' => $moodeluservalueteacher->email,
                            ...
                            'phone' => $moodeluservalueteacher->phone,
                            'moodle_phone' => $moodeluservalueteacher->phone2,
                            'adress' => $moodeluservalueteacher->adress,
